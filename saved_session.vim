...
nmap ys <Plug>Ysurround
nnoremap <SNR>179_: :=v:count ? v:count : ''
...
nnoremap <silent> <Plug>VimyouautocorrectPrevious :call vim_you_autocorrect#previous()
nnoremap <silent> <Plug>VimyouautocorrectNext :call vim_you_autocorrect#next()
nnoremap <silent> <Plug>VimyouautocorrectJump :call vim_you_autocorrect#jump_to_last()
nnoremap <silent> <Plug>VimyouautocorrectUndo :call vim_you_autocorrect#undo_last()
...
noremap <F6> :source saved_session.vim
noremap <F5> :mksession! saved_session.vim
...
xnoremap <buffer> <silent> <SNR>108_(vimtex-[*) :call vimtex#motion#comment(0,1,1)
xnoremap <buffer> <silent> <SNR>108_(vimtex-[/) :call vimtex#motion#comment(1,1,1)
xnoremap <buffer> <silent> <SNR>108_(vimtex-]*) :call vimtex#motion#comment(0,0,1)
xnoremap <buffer> <silent> <SNR>108_(vimtex-]/) :call vimtex#motion#comment(1,0,1)
...
xnoremap <buffer> <silent> <SNR>108_(vimtex-[M) :call vimtex#motion#environment(0,1,1)
xnoremap <buffer> <silent> <SNR>108_(vimtex-[m) :call vimtex#motion#environment(1,1,1)
xnoremap <buffer> <silent> <SNR>108_(vimtex-]M) :call vimtex#motion#environment(0,0,1)
xnoremap <buffer> <silent> <SNR>108_(vimtex-]m) :call vimtex#motion#environment(1,0,1)
...
xnoremap <buffer> <silent> <SNR>108_(vimtex-[[) :call vimtex#motion#section(0,1,1)
xnoremap <buffer> <silent> <SNR>108_(vimtex-[]) :call vimtex#motion#section(1,1,1)
xnoremap <buffer> <silent> <SNR>108_(vimtex-][) :call vimtex#motion#section(1,0,1)
xnoremap <buffer> <silent> <SNR>108_(vimtex-]]) :call vimtex#motion#section(0,0,1)
...
xnoremap <buffer> <silent> <SNR>108_(vimtex-%) :call vimtex#motion#find_matching_pair(1)
nnoremap <buffer> <silent> <Plug>(vimtex-%) :call vimtex#motion#find_matching_pair()
nnoremap <buffer> <SNR>108_(V) V
nnoremap <buffer> <SNR>108_(v) v
...
silent! normal! zE
let s:l = 48 - ((42 * winheight(0) + 24) / 48)
...
normal! 05|
tabnext 1
badd +51 00_master.tex
badd +1 preamble/documentInfos.tex
badd +1 content/02_abstract.tex
badd +3 content/98_acronym.tex
badd +1 content/04_introduction.tex
badd +1 content/05_mathematical_principles.tex
badd +1 content/06_used_components.tex
badd +1 content/07_realization.tex
badd +1 content/08_results.tex
badd +1 content/09_outlook.tex
badd +1 content/99_appendix.tex
badd +1 ~/repos/bachelor-thesis/./bib/literature.bib
